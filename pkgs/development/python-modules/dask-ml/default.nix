...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ nur.repos.awl-fcarza.distributed nur.repos.awl-fcarza.dask numpy toolz numba pandas scikitlearn scipy dask-glm six multipledispatch packaging ];
